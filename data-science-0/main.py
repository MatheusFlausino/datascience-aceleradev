...
# max(black_friday.isna().sum()) / len(black_friday.index)


# black_friday_norm = (black_friday - black_friday.mean()) / (black_friday.max() - black_friday.min())
# black_friday.max() - black_friday.min()
...
def q2():
    ...
    df_filterfame = black_friday['Gender'] == 'F'
    df_filterage = black_friday['Age'] == '26-35'
    return len(black_friday[df_filterfame & df_filterage].index)
...
def q5():
    ...
    return float(max(black_friday.isna().sum()) / len(black_friday.index))
